...
class Crud extends Database {
	...
	public function addProduct($name, $description, $stock, $price, $createdby){
		$insert = $this->connection->prepare("INSERT INTO `products` (`Name`, `Description`, `Stock`, `Price`, `Created_By`) VALUES ('$name', '$description', $stock, $price, $createdby)");
		$insert->execute();
	}
