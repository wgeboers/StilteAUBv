...
<head>
    ...
    <meta name="description" content="Hire your own do it yourself Silent-Disco kit with headphones! Within minutes you will get your own party started!">
            ...
            <div class="hexagon">
                ...
                <div class="text">
                    <div>
                        ...
                        <p> Hire your own do it yourself Silent Disco starterskit. Our system is compatible with the latest DJ equipment and laptops with added theme songs. Within moments you can get your very own Silent Disco started!</p>
                    </div>
                </div>
            </div>
            <div class="hexagon2">
...
<div class="contact" id="contact">
    ...
    <form id="contactForm" class="row">
        ...
        <div class="col-md-6">
            ...
            <small id="emailHelp" class="form-text text-muted">We won't share your email with third parties!</small>
        </div>
        <div class="col-md-6">
            <label for="" class="form-label">Phone number (Caution include land code!)</label>
