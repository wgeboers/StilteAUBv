...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `users_updateName` (`id` INT(11), `FN` VARCHAR(25), `LN` VARCHAR(25)) RETURNS INT(11) BEGIN
...
INSERT INTO `searchqueries` (`id`, `terms`, `amount`) VALUES
(0, 'disco', 2),
(1, '90s', 5);
